pageextension 50000 PurchOrderCardExt extends "Purchase Order"
{
                ...
                begin
                    ...
                    if recuser.FindFirst() then begin
                        ...
                        if recuser."Contact Email" <> '' then begin
                            ...
                            //send
                            if cuSendMail.ReportSendMailWithExternalAttachment(404, RecRef, RecRef.number, PurchaseHeader."No.", ToAddr, 'ODA ' + PurchaseHeader."No.", 'Purch. Order Documents', PurchaseHeader."No." + ' ' + PurchaseHeader."Pay-to Name" + '.pdf') then
                                Message(text001);
                        end
                        else
                            Message(text002);
